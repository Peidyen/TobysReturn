...
# Handle the base path for PyInstaller or normal script execution
...
# Load sound file
sound_file = os.path.join(base_path, 'BalloonPop.wav')

# Load image files
balloon_image_file = os.path.join(base_path, 'balloon.gif')
butters_image_file = os.path.join(base_path, 'Butters.png')
...
blip_sound = pygame.mixer.Sound(sound_file)

# Load and resize the paddle image (Butters)
paddle_image = pygame.image.load(butters_image_file)
...
balloon_image = pygame.image.load(balloon_image_file)
